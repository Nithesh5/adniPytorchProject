...
from softmax.data_loader__softmax_2nodes_cc import ADNIDataloaderAllData
import pandas as pd
...
labels_df_AD = whole_labels_df_AD.iloc[0:320, :]
...
labels_df_AD = whole_labels_df_AD.iloc[320:420, :]
...
labels_df_AD = whole_labels_df_AD.iloc[420:471, :]
...
for epoch in range(num_epochs):
    ...
    torch.save(model.state_dict(), 'best_checkpoint'+str(epoch)+'.model')
...
with torch.no_grad():
    for i, (images, labels) in enumerate(test_loader):
        ...
        x.append(index1)
        index2 = prediction.cpu().data.numpy()
        y.append(index2)
